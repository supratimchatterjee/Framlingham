				...
				<div class="uk-width-medium-3-4 uk-block-muted white-bg">
					<div class="uk-panel uk-panel-space">
						...
						<div class="featured-image-panel section-faq">
							...
							<?php if( have_rows('tabs_fees') ): ?>
									<?php $i=1;  ?>	   
								<?php while( have_rows('tabs_fees') ): the_row(); ?>
							...
							<?php if($testimonial_ids): ?>
								...
								<?php else: ?>
									<div class="uk-slidenav-position fram-testimonial-block uk-margin-large-top uk-text-center" data-uk-slideshow="{autoplay:true, autoplayInterval: 4000}">
